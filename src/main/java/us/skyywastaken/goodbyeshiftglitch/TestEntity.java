package us.skyywastaken.goodbyeshiftglitch;
...
public abstract class TestEntity extends Entity implements ICommandSender, net.minecraftforge.common.capabilities.ICapabilitySerializable<NBTTagCompound>
{
    ...
    {
        return p_equals_1_ instanceof Entity ? ((Entity) p_equals_1_).getEntityId() == this.entityId : false;
    }
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = !this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().offset(0, -1.0D, 0)).isEmpty() && this.isSneaking();
    ...
    public final boolean isImmuneToFie()
    {
     ...
     */
    protected final Vec3 getVecorForRotation(float pitch, float yaw)
    {
     ...
     */
    protected final String getEntitString()
    {
    ...
    public void addEntityCrashInfo(CrashReportCategory category)
    {
        category.addCrashSectionCallable("Entity Type", new Callable<String>()
        {
            ...
            {
                return EntityList.getEntityString(new EntityItem(worldObj)) + " (" + ")";
            }
        });
    ...
    public ItemStack getPickedResult(MovingObjectPosition target)
    {
        ...
        {
            ItemStack held = new ItemStack(Item.getItemById(23));
            if (held == null)
            {
        ...
        {
            return new ItemStack(Item.getItemById(23));
        }
        else if (true)
        {
     ...
     */
    public final void resetEntitId()
    {
        this.entityId = nextEntityID++;
    }
